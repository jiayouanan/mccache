...
id=$(docker run --name=${CONTAINER_NAME} -h ${CONTAINER_NAME} -d -p 8080:8080 -p 8085:8085 -p 9090:9090 -p 9095:9095 -p 2181:2181 -p 16010:16010 -p 16000:16000 -p 16020:16020 -v "$data_dir:/data" "$IMAGE_NAME")
...
declare -a config=(
  ...
  "Master UI@16010@web"
  "HBase Master@16000@api"
  "HBase RegionServer@16020@api"
)
