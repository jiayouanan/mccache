...
public class JdbcDBClient extends DB {
  ...
  public void init() throws DBException {
    ...
    this.printExe = props.getProperty(PRINT_OR_EXE, DEFAULT_PROP);
...
//  TODO: check product name and version rather than driver name
  ...
  public Status readtxn(ArrayList<TCacheQuery> readlist) {
    try {
      ...
      System.err.println("Error in processing read-only transaction: " + e));
      return Status.ERROR;
    }
  }
  ...
  public Status writetxn(ArrayList<TCacheQuery> writelist) {
    try {
      ...
      System.err.println("Error in processing write-only transaction: " + e));
      return Status.ERROR;
    }
  }
  // modification ended
