...
// // added by W.Z
// interface OnlyTransaction {
//   public abstract int doOnlyTransactions(DBTxn dbtxn, Object threadstate);
// }
// // modification ended
...
public abstract class Workload {
  ...
  // added by W.Z
  // protected OnlyTransaction onlyTransaction;

  // public OnlyTransaction getOnlyTransaction() {
  //   return this.onlyTransaction;
  // }
  public int doOnlyTransactions(DB db, Object threadstate) {
    return 0;
  }

  // For synthetic workloads, transactions are specified.
  public int doSynthTransactions(DB db, Object threadstate) {
    return 0;
  }
  // modification ended
