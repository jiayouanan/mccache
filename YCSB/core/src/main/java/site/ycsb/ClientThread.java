  ...
  public void run() {
    ...
    try {
      if (dotransactions) {
        ...
        // added by W.Z
        if (this.props.getProperty("rwonlytxnprop", "false").equals("true")) {
          System.out.println("Running read-only, write-only transaction test for TCacheWorkload......");
          workload.doOnlyTransactions(db, workloadstate);
          throttleNanos(startTimeNanos);
        } else if (this.props.getProperty("syntheticprop", "false").equals("true")) {
          System.out.println("Running synthetic transaction sequence for TCacheWorkload......");
          workload.doSynthTransactions(db, workloadstate);
        } else {
