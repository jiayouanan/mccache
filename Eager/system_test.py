...
from MMCache.sys_op import WorkloadTest, SystemOperator
import os
import time
...
def alg_process(alg_dict, queue):
    ...
    reorder_flag=alg_dict['reorder_flag'], liveness_bound=alg_dict['liveness_bound'],  reorder_name=alg_dict['reorder_name'], opt_len=alg_dict['opt_len'], ob_acc=alg_dict['ob_acc'])
