...
This repository releases the source codes and datasets for mccache paper (Making Cache Monotonic and Consistent). Please refer to our full version to get the formal proofs of all the results, additional experiments and the ML model details. Full version link: https://homepages.inf.ed.ac.uk/ycao/MCCfull.pdf
